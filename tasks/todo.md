...
- [ ] Full 4-step Enter SHEET modal (Connect/Review/Sign route-chips/Result+Refund) + slide-over account panel — design has them; current build uses an inline BuyBox + NAV-bar passkey instead (functional). Optional fidelity polish.
