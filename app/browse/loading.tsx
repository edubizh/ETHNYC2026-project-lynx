  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0B0E", color: "#FFFFFF", fontFamily: BODY }}>
      ...
      <main style={{ maxWidth: 1180, margin: "0 auto", padding: "28px 24px" }}>
        <div className="lx-sk" style={{ width: 240, height: 30, borderRadius: 8, background: "#1B1E24", marginBottom: 8 }} />
        <div className="lx-sk" style={{ width: 360, height: 14, borderRadius: 6, background: "#1B1E24", marginBottom: 22 }} />
